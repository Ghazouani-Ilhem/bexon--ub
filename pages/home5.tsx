...
const Home5Page: React.FC = () => {
  return (
    <Layout>
      {/* Hero Section */}
      <section className="tj-hero-section-5 section-gap-x">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="hero-content-5 wow fadeInLeft" data-wow-delay=".3s">
            ...
            <div className="col-lg-6">
              <div className="hero-img-5 wow fadeInRight" data-wow-delay=".5s">
                <Image src="/assets/images/hero/hero-img-4.webp" alt="Hero" width={600} height={500} />
              </div>
            </div>
          </div>
        </div>
